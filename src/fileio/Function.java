...
public final class Function {
    ...
    public ArrayNode gwentStone(final Input input, final ArrayNode output) {
        ...
        ArrayList<CardInput> pDeck1;

        ArrayList<CardInput> pDeck2;
        ...
        gameInput = input.getGames().get(0);
        ...
        pDeck1 = input.getPlayerOneDecks().getDecks().get(startGameInput.getPlayerOneDeckIdx());

        pDeck2 = input.getPlayerTwoDecks().getDecks().get(startGameInput.getPlayerTwoDeckIdx());
